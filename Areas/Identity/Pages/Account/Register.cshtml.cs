...
namespace AppInventario.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                ListaRol = _roleManager.Roles.Where(x => x.Name != DS.Role_Cliente).Select(x => x.Name).Select(x => new SelectListItem
                {
                    Text = x,
                    Value = x
                })
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    else
                    {
                        ...
                        {
                            //Administrador esta ingresando un nuevo usuario
